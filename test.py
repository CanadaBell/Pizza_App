pizza_address = '11430 68 St NW'
pizza_ave = 114
pizza_st = 68 #Addres of Eastglen (Pizza Place) inclues ave and st used for math later
deliv_address = '14616 31 st nw' #Where the user will input their address
...
deliv_time = 15 + (0.2 * total_diff) #calculates a rough delivery time
